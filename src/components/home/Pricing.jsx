    ...
    <section className="h-full" id="pricing">
      <div className="pricing-container max-w-full mx-auto py-24 px-6 bg-gradient-to-r from-white to-gray-200">
        ...
        <p className="text-center text-lg text-gray-700 mt-2 px-6">
          Our flexible pricing options ensure that you receive the value you deserve while staying within your budget/requirements.
        </p>
            ...
            <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-mr-4">
              <div className="bg-white text-black rounded-lg shadow-inner overflow-hidden">
                ...
                <div className="flex items-center p-8 uppercase">
                  <button className="mt-3 text-lg font-semibold bg-primary-600 w-full text-white rounded-lg px-6 py-3 block shadow-xl hover:bg-gray-700">
                    Select
                  </button>
                </div>
              </div>
