...
function ContactUs() {
  return (
    <section className="bg-gradient-to-r from-white to-gray-100">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-4xl tracking-tight font-bold text-center text-gray-600 dark:text-white">
          Contact Us
        </h2>
